...
describe('#versionGuard', function() {
  ...
  it('throw a warning if version is already defined', function() {
      ...
      should.equal(console.warn.calledWith('More than one instance of bitcore-lib-dash found. Please make sure that you are not mixing instances of classes of the different versions of dashcore.'),true)
  });
});
